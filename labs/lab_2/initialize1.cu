...
// Write kernel for initiailizing as C[i] = A[i] + B[i]
...
int main(){
    ...
    for (int i = 0; i < 1000; i ++){
        ...
        // Create kernel with block size = 128 threads. Call the initialize1 kernel. 
        initialize1<<<num_blocks,block_size>>>(d_c);
    ...
    std::cout << "Initialize 1 : " << time/1000 << std::endl; 
